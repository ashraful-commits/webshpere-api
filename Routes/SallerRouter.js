...
const { createSeller, getAllSeller, me, sellerLogin, LogoutSeller, updateSellerRole, getSingleSeller } = require('../Controller/SellerController.js');
...
sellerRouter.route("/:id").put(updateSellerRole).get(getSingleSeller)
